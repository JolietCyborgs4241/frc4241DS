...
//WheelBase is intended for different drive methods, and is not used for the purpose of our robot
    ...
    //A is not used for the purpose of our robot, meant for other drive systems
...
// map analog encoder values to radians or degrees
  ...
  public:
    ...
    void SetWheelbase(float x, float y);
